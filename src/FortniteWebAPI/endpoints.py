...
matchmaking_session_find_player = 'https://fortnite-public-service-prod11.ol.epicgames.com/fortnite/api/matchmaking/session/findPlayer/{}'


token = 'https://account-public-service-prod03.ol.epicgames.com/account/api/oauth/token'
device = 'https://account-public-service-prod.ol.epicgames.com/account/api/public/account/{}/deviceAuth'
csrf = 'https://www.epicgames.com/id/api/csrf'
